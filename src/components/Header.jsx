...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        Bring your ideas to life with AI. Transform your imagination into
        stunning visuals in seconds—just type and let the magic unfold.
      </motion.p>
      ...
      className="mt-2 text-neutral-600 ">Generated images from LluvAi</motion.p>
    </motion.div>
=======
...
const Header = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center my-20">
      ...
      <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full '>Generate Images <img className='h-6' src={assets.star_group} alt="" />
      </button>
      ...
      <p className='mt-2 text-neutral-600 '>Generated images from LluvAi</p>
